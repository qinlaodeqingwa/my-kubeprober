...
import (
	...
	"kubeprober/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d4fa5f40.erda.cloud",
	...
	if err := (&controller.ProbeReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("kubeprober"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "Probe")
		os.Exit(1)
	}
